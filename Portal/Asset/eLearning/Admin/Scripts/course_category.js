...
jQuery(document).ready(function () {
    jQuery("#btnAddCourseCategory").click(function () {
...
function save_course_category() {
    ...
    if (is_edit == "EDIT") {
        var url = DOMAIN + "ElaCourseCategory/Update";
        ...
        var url = DOMAIN + "ElaCourseCategory/Create";
        var user = get_form_value();
...
$(document).ready(function () {
    var urlGetPaging = DOMAIN + 'ElaCourseCategory/GetAllPaging';
...
function deletecategory(id) {
    ...
    if (r == true) {
        var url = DOMAIN + "ElaCourseCategory/Delete";
...
function getCategoryById(id) {
    var url = DOMAIN + "ElaCourseCategory/GetById";
    showProgressWaiting();

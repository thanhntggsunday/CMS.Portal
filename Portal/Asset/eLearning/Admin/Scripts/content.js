...
jQuery(document).ready(function () {
    ...
    jQuery("#btnAddContent").click(function () {
    ...
    $('#ContentForm').on('dialogclose', function (event) {
        reset_form_value();
    });
...
function save_Content() {
    ...
    if (is_edit == "EDIT") {
        var url = DOMAIN + "ElaContent/Update";
        ...
        var url = DOMAIN + "ElaContent/Create";
...
function get_form_value() {
    ...
    appContent.ContentName = jQuery("#ContentName").val();
...
function set_form_value(object_value) {
    ...
    jQuery("#ContentName").val(object_value.ContentName);
...
jQuery(document).ready(function () {
    jQuery("#ContentForm").validate({
        ...
        messages: {
            ContentName: {
                required: "Please enter ContentName.",
            }
        },
        errorElement: "span",
        errorClass: "error",
...
$(document).ready(function () {
    //---$('#reservation').val("");
    var urlGetPaging = DOMAIN + 'ElaContent/GetAllPaging';

    dataTable = $('#tbl_Contents').DataTable({
        "processing": true,
        "serverSide": true,
        "paging": true,
        "pageLength": 5,
            ...
            "dataSrc": function (json) {
                ...
                if (json.data != null && json.data != undefined) {
                    for (var i = 0, ien = json.data.length; i < ien; i++) {
                        ...
                        let deleteContent = "<button class='btn-edit-Content' onclick=\"deleteContent('" + json.data[i].Id + "')\">" + "Delete" + "</button>";
        ...
        "columns":
            [
                ...
                {
                    "title": "Content Name", "data": "ContentName", "orderable": false
                },
                {
...
function getContentById(id) {
    var url = DOMAIN + "ElaContent/GetById";
...
function GetAllCategories(categoryIdSelected, ContentData) {
    var ddlCustomers = $("#ddlCategories");
    ddlCustomers.empty().append('<option selected="selected" value="0" disabled = "disabled">Loading.....</option>');
    $.ajax({
        type: "GET",
        url: "/ElaContentCategory/GetAll",
        data: '{}',

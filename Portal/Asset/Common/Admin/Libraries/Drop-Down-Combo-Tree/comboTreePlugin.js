...
var comboTreePluginSelectedItems = [];
...
; (function ($, window, document, undefined) {
    ...
    ComboTree.prototype.selectMultipleItem = function (ctItem) {
        ...
        if (index) {
            ...
            // 2019-12-05: ThanhNT update:
            comboTreePluginSelectedItems = this._selectedItems;

            let messageRequiredSelectEmployees = "Please selected employee!";

            if (comboTreePluginSelectedItems.length > 0) {
                if (document.getElementById("msg-member") != null && document.getElementById("msg-member") != undefined) {
                    document.getElementById("msg-member").innerHTML = "";
                }

                if (document.getElementById("msg-role") != null && document.getElementById("msg-role") != undefined) {

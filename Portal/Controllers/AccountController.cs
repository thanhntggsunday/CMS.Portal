        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    var lstUserPers = permissionHandle.GetAllUserPermissionByUserId(user.Id);
                    Session[SessionConstants.USER_PERMISSION] = lstUserPers;
                    Session[SessionConstants.USER_SESSION] = user;
